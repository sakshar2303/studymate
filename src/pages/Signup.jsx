    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 px-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <p className="text-slate-400 mt-2">Start your personalized study journey</p>
        </div>

        <Card>
          <CardHeader>
            <h2 className="text-xl font-semibold text-white">Create Account</h2>
            <p className="text-sm text-slate-400">Join StudyMate and track your success</p>
          </CardHeader>
          <CardBody className="space-y-4">
            ...
            <p className="text-center text-sm text-slate-400">
              ...
              <button onClick={() => navigate(ROUTES.LOGIN)} className="text-amber-400 hover:underline">
                Sign in
              </button>
            </p>
          </CardBody>
